...
def count_photons_no_cut(time, ch, config ):                                            #argument: ph. channel, energy, time 
...
if __name__ == '__main__':
    ...
    idrun = content[7]          #run identifier (UUID) (True or False)  ------------------>>>>> if True, read also line 7
